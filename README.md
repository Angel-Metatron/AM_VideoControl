...
- Масштаб / Свободный Зум (Alt + Колесо мыши, Alt + Num+/Num-) от -10x до +10x, как в большую, так и в меньшую сторону, сброс масштаба (Alt + 0/Num0). Перемещение по увеличенному видео с помощью перетаскивания мышкой. Зажмите левую кнопку мыши на приближенном видео, чтобы свободно двигать кадр.
...
- ИИ-видео в книжном формате с полями по бокам типа шортсов, или для шортсов открываемых через `/watch?v=id`, с этим скриптом видео можно повернуть и оно заполнит весь экран.
- Мобильный контент на ПК: ~~YouTube Shorts, TikTok-видео или~~ ролики, снятые на телефон, которые неудобно смотреть в стандартной горизонтальной ориентации. (В процессе)
